...
class HelperFunctions {
  ...
  static String sharedPrefsIsViewed = "ISVIEWED";
  static Future<bool> saveIsViewedState(bool isViewed) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setBool(sharedPrefsIsViewed, isViewed);
  }
   static Future<bool?> getIsViewedState() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return preferences.getBool(sharedPrefsIsViewed);
  }
...
// ================================================================================================================
  ...
  static Future<bool> saveStudentNameSharedPreference(String userName) async {
    ...
    return await preferences.setString(
        sharedPreferenceStudentNameKey, userName);
  }

  static Future<bool> saveTeacherNameSharedPreference(String userName) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(
        sharedPreferenceTeacherNameKey, userName);
  }
